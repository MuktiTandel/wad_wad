...
class AddYourProfileScreen extends StatefulWidget {
   const AddYourProfileScreen({Key? key}) : super(key: key);

  @override
  State<AddYourProfileScreen> createState() => _AddYourProfileScreenState();
}

class _AddYourProfileScreenState extends State<AddYourProfileScreen> {

   final controller = Get.put(AddYourProfileController());
